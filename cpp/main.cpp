...
int main()
{
    ...
    printf("\033[%dm,\033[m", 95);
    printf("\033[%dmBFS \033[m", 92);
    printf("\033[%dmand \033[m", 95);
    printf("\033[%dmBidirectional Search \033[m", 92);
...
p:
    ...
    while (1)
    {
        if (std::cin >> r)
        {
            ...
            else if(r>40)
            {
                ...
                printf("\033[%dm than VScode console size ⛔! Try lower dimentions (Maximum = 40) : \033[m", 91);
                std::cin.clear();
                while (std::cin.get() != '\n');
            }
            else    
    ...
    printf("\033[38;5;%dm ⬇⬇⬇⬇⬇⬇ THIS IS DFS ALGORITHM ⬇⬇⬇⬇⬇⬇ \033[m", 121);
    n.dfs(2);
    n.path_show(n.DFS_maze);
    printf("\033[38;5;%dmThis path used\033[m", 154);
    ...
    std::cout<<"\n";
    printf("\033[38;5;%dm\n ⬇⬇⬇⬇⬇⬇ THIS IS BIDIRECTIONAL SEARCH ALGORITHM ⬇⬇⬇⬇⬇⬇ \033[m", 121);
    n.Backward_bfs();
    n.bidirectional();
    n.path_show(n.Bidirectional_maze);
    std::cout<<"\n";
    printf("\033[38;5;%dmThis path used\033[m", 154);
    printf("\033[%dm%3ld\033[m",91,n.bidirectional_cells_to_goal+1);
    printf("\033[38;5;%dm cells to reach the goal cell which is the shortest path possible!\033[m\n\n", 154);
